...
import css from "./backCircle.module.css";
...
const BackCircles = ({ inView, direction, whichPage }: Prop) => {
  ...
  return (
    <div
      className={`absolute z-10 inset-0 overflow-hidden w-[100%] h-[100%] mx-auto flex flex-col ${
        direction === "top" ? "justify-start" : "justify-end"
      } items-center`}
    >
      <div
        style={{
          borderRadius: `${direction === "top" ? "0px 0px" : ""} ${
            width > 1100
              ? "500px 500px"
              : width > 1000
              ? "450px 450px"
              ...
              ? "250px 250px"
              : "200px 200px"
          } ${direction === "bottom" ? "0px 0px" : ""}`,
        }}
        className={`${css.semicircle} ${inView ? css.semicircle2InView : ""} ${
          PageColor()[0]
        } flex ${
          direction === "top" ? "items-start" : "items-end"
        } justify-center`}
      >
        <div
          style={{
