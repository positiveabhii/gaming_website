...
import { gameBelowContent, popupContent } from "../../content/game/pageContent";
          ...
          <div className="md:mt-12 z-[1000] relative flex flex-col items-center justify-center">
            ...
            >
              ...
              <GameBoard
                ...
                ghostCount={
                  popupContent[category as string][stepIndex].noOfGhost
                }
                    ...
                    startTaskAnimte.map((itm, ind) => (
                      ...
                      >
                        ...
                        <h1 className="text-[14px] flex items-start flex-col justify-center mt-2 text-[#F2F2F2]">
                          <img
                            src={
                              popupContent[category as string][stepIndex]
                                .actions[itm - 4].icon
                            }
                            alt={"task1"}
                            width={20}
