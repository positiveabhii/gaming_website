  ...
  return (
    <Fragment>
      ...
      <div className="w-full relative min-h-screen" id="homePage">
        ...
        <div className="relative max-w-[1300px] w-[90%] mx-auto z-[100] flex flex-col items-center gap-4 py-12">
          <div className="pb-12">
            <h1
          ...
          <div className="py-12">
            ...
            <div className="w-[90%] mx-auto">
              <h3
                ...
                className="text-white rajdhani  max-w-[820px] mt-3 font-semibold text-md leading-[150.5%]"
              >
                Whether you’re a digital agency, a technology company, a
                freelance visual communicator or developer, or even an
                influencer, partnering with us will be a win-win. You’ll be
                assured of exciting projects where you or your team can
                contribute independently, the opportunity to brainstorm with PPV
                experts to take creativity to the next level, and an environment
                of respect and trust that makes the partnership something to
                look forward to.
              </h3>
              <h3
                style={{ textShadow: "0px 4px 4px rgba(0, 0, 0, 0.25)" }}
