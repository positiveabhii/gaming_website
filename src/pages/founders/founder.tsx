...
import CardDeck from "../../components/founder/cardDeck";
    ...
    <Fragment>
      ...
      <div className="w-full flex flex-col relative min-h-screen" id="homePage">
        <div id="homePage" className="absolute min-h-screen z-[100] w-full">
          ...
          <div className="top-8 text-center z-[100] relative flex flex-col w-[90%] mx-auto items-center justify-center gap-4">
            <h1
              style={{
