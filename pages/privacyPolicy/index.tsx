  ...
  return (
    ...
    >
      <div className="block max-w-[1000px] mx-auto m-16 p-12 border-2 border-solid border-[#dadada] rounded-md">
        <h1 className="mb-[0.5em] text-[2em] font-bold">
          Privacy Policy of Platform Play Venture
        </h1>

        <p className="text-[1em] mb-[1em]">
          Platform Play Venture operates the https://platformplay.in/ website,
        ...
        <p className="text-[1em] mb-[1em]">
          ...
          anyone decided to use our Service, the Platform Play Venture website.
        </p>
        ...
        <p className="text-[1em] mb-[1em]">
          ...
          Terms and Conditions, which is accessible at https://platformplay.in/,
        ...
        <h2 className="text-[1.5em] mb-[0.5em] font-bold">Log Data</h2>
        ...
        <h2 className="text-[1.5em] mb-[0.5em] font-bold">Cookies</h2>
        ...
        <h2 className="text-[1.5em] mb-[0.5em] font-bold">Service Providers</h2>
        ...
        <h2 className="text-[1.5em] mb-[0.5em] font-bold">Security</h2>
        ...
        <p className="text-[1em] mb-[1em]">Children's Privacy</p>
        ...
        <h2 className="text-[1.5em] mb-[0.5em] font-bold">Contact Us</h2>
