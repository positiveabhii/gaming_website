...
const Section4 = () => {
  ...
  return (
    <div className="flex flex-col items-center w-[90%] justify-center max-w-[1300px] mx-auto">
      ...
      <section>
        <div className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
          <h2 className="text-center text-4xl font-bold tracking-tight text-[#dadada] sm:text-5xl">
